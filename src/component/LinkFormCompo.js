...
function LinkFormCompo() {
    const {setindexhandle,indexhandle,editehandle,seteditehandle,setnews,news,setformShow,formShow,newstitle,setnewstitle,newsurl,setnewsurl,newsseq,setnewsseq,newsdate,setnewsdate} = useContext(LinkContext);
